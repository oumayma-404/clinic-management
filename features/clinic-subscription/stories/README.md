...
|-------|-------|------|--------|------------|
| 1 | Full | [Abonnement du cabinet — entitlement, enforcement, visibility and vendor control](./story-1-full-clinic-subscription.md) | in-progress (Part A done) | - |
...
| B | An expired cabinet keeps its records and loses only recording | BE | — | A |
| C | The cabinet can see where it stands and how to pay | BE + FE | — | A, B |
