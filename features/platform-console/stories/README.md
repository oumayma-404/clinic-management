...
|-------|-------|------|--------|------------|
| 1 | Full | [The vendor runs the practice portfolio from a private console](./story-1-full-platform-console.md) | in-progress (Parts 1-2 done) | `features/clinic-subscription/` (Parts 4–7 only) |
