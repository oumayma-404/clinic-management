...
| 5 | Phase 1 | The iOS shell | ⚠️ **written 2026-08-06, never compiled** | AC-13…AC-27 (iOS half) | **still blocked** — the code exists and a free `macos-latest` CI workflow with it; the blocker narrowed to **one green run**, then a free-Apple-ID sideload. The **$99 Apple Developer Program** remains the only condition with no free answer, and it gates the App Store, TestFlight and APNs (`progress.md` § Session 8) |
