...
|---|---|---|---|---|
| **P1** Installer filesystem posture | US-1, US-2, US-3 | 🔴×4 | Operator only (`packaging/` R-1) | in progress |
| **P2** Backup output posture | US-14 | 🔴 | `dotnet test` + operator | pending |
| **P3** Auth & session | US-4, US-5 | 🔴 + 🟠 | `dotnet test` + manual | pending |
