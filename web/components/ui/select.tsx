...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        // A stacked list row grows its own height rather than carrying a `touch-target` overlay: adjacent rows'
        // 44px overlays would overlap and steal each other's taps, selecting the wrong option (AC-10).
