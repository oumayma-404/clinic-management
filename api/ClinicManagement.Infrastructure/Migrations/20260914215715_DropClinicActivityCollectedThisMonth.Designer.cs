...
namespace ClinicManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260914215715_DropClinicActivityCollectedThisMonth")]
    partial class DropClinicActivityCollectedThisMonth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClinicManagement.Domain.Entities.DentalRecordAct", b =>
                {
                    ...
                    b.Property<string>("PonticToothNumbers")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ClinicManagement.Domain.Entities.Patient", b =>
                {
                    ...
                    b.Property<DateTime?>("DentitionAnsweredAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("ClinicManagement.Domain.Entities.PatientFileAnnotation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<double>("NormalX")
                        .HasColumnType("double precision");

                    b.Property<double>("NormalY")
                        .HasColumnType("double precision");

                    b.Property<double>("NormalZ")
                        .HasColumnType("double precision");

                    b.Property<Guid>("PatientFileId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PatientFileAnnotations", (string)null);
                });
                    ...
                    b.OwnsOne("ClinicManagement.Domain.ValueObjects.TobaccoUse", "TobaccoUse", b1 =>
                        {
                            ...
                            b1.Property<int?>("PerDay")
                                .HasColumnType("integer")
                                .HasColumnName("SmokingPerDay");

                            b1.Property<int>("Status")
                                .HasColumnType("integer")
                                .HasColumnName("SmokingStatus");

                            b1.Property<int?>("Unit")
                                .HasColumnType("integer")
                                .HasColumnName("SmokingUnit");
            ...
            modelBuilder.Entity("ClinicManagement.Domain.Entities.PatientFileAnnotation", b =>
                {
                    b.HasOne("ClinicManagement.Domain.Entities.PatientFile", "File")
                        .WithMany()
