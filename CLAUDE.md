...
- **Something now PRODUCES an archive, and the practice is told when none has left the building
  (`clinic-recovery-points`)**: the archive/restore feature above was a complete recovery mechanism with **nothing
