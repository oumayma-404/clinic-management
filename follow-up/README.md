...
| [Verify/regenerate the CNAM EF migration with the EF tool](./cnam-migration-ef-verify.md) | cnam-bulletin-soins | parked | high | 2026-07-17 |
| [Validate & correct the BS1 PDF against the official form](./cnam-bs1-pdf-fidelity.md) | cnam-bulletin-soins | parked | high | 2026-07-17 |
| [Admin editing of CNAM nomenclature + reimbursement rates](./cnam-nomenclature-admin-editing.md) | cnam-nomenclature-lookup | parked | medium | 2026-07-17 |
| [Prosthesis (Prothèses dentaires) flow on the bulletin](./cnam-prosthesis-flow.md) | cnam-bulletin-soins | parked | medium | 2026-07-17 |
| [BS1 bulletin lifecycle status tracking](./cnam-bulletin-lifecycle-status.md) | cnam-bulletin-soins | parked | medium | 2026-07-17 |
| [CNAM identity backfill for existing patients](./cnam-identity-backfill.md) | cnam-bulletin-soins | parked | low | 2026-07-17 |
| [Complete bilingual FR/AR labels (CNAM UI + PDF)](./cnam-bilingual-fr-ar.md) | cnam-bulletin-soins | parked | low | 2026-07-17 |
| [Conventionné pathway: bordereau + télétransmission](./cnam-conventionne-bordereau.md) | cnam-bulletin-soins | parked | low | 2026-07-17 |
| [BS1 overlay — deferred review findings (font bundling, job failure surfacing, non-retryable fail-fast)](./cnam-bs1-overlay-deferred-review.md) | cnam-bs1-official-overlay | parked | medium | 2026-07-20 |
| [Embed the real BS1 in the document-editor preview](./cnam-bs1-live-preview.md) | cnam-bs1-official-overlay | parked | medium | 2026-07-20 |
...
| [The PDF viewer's own toolbar saved as a bare UUID — the cause was the URL path, not the headers](./pdf-viewer-toolbar-saves-without-a-name.md) | documents | bug | 2026-09-10 |
...
>
> ⚠️ **The ten `cnam-*` items above are `parked`, not open.** Every browser surface they describe was
> withdrawn — see [`../features/cnam-ui-withdrawal/notes.md`](../features/cnam-ui-withdrawal/notes.md). The
> server side each one targets is untouched, so they become actionable again the day the interface returns.
